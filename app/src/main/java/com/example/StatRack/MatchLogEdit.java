...
public class MatchLogEdit extends AppCompatActivity {

    private static final String TAG = "MatchLogEdit";

    private EditText matchlogInput, oppositionInput, locationInput, starttimeInput, endtimeInput, dateInput,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_match_log_edit);
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                toastMessage("Saving " + opposition + " match log to your match log list...");
    ...
    private void toastMessage(String message){
        Toast.makeText(MatchLogEdit.this,message,Toast.LENGTH_SHORT).show();
    }

    public void backToMenu(){
        Intent intent = new Intent(MatchLogEdit.this, MenuActivity.class);
